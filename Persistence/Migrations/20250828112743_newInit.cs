        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PollId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SubmmitedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "0198d5c2-4e9d-713a-aa78-e6853aee4737", 0, "0198d5cb-b811-7192-8357-d513ae755b25", "admin@survey-basket.com", true, "Survey Basket", false, "Admin", false, null, "ADMIN@SURVEY-BASKET.COM", "ADMIN@SURVEY-BASKET.COM", "P@ssword123", null, false, "24762FF6-A857-4409-9F31-D7F7CDEA4F0D", false, "admin@survey-basket.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "permissions", "polls:read", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 2, "permissions", "polls:add", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 3, "permissions", "polls:update", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 4, "permissions", "polls:delete", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 5, "permissions", "questions:read", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 6, "permissions", "questions:add", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 7, "permissions", "questions:update", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 8, "permissions", "users:read", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 9, "permissions", "users:add", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 10, "permissions", "users:update", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 11, "permissions", "roles:read", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 12, "permissions", "roles:add", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 13, "permissions", "roles:update", "0198dc42-e2ee-73cc-9237-12f4c152c332" },
                    { 14, "permissions", "results:read", "0198dc42-e2ee-73cc-9237-12f4c152c332" }
                });
